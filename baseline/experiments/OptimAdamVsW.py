...
def _build_sweep_group() -> str:
    ...
    return f"p0-group-Optim-Adam-vs-AdamW-wikitext2_gpt2-sweep-{timestamp}"


def _build_run_name(optim: str, weight_decay: float) -> str:
    return f"p0-group-Optim-Adam-vs-AdamW-wikitext2-gpt2-optim-{optim}-wd{weight_decay:g}"

def build_config(
    optimizer_type: str, # "adam" or "adamw"
    weight_decay: float,
    *,
    ...
    return ExperimentConfig(
        run=RunConfig(
            ...
            run_name=_build_run_name(optimizer_type, weight_decay),
...
def main() -> int:
    ...
    for summary in results:
        print(
            ...
            f"optimizer_type={summary['optimizer_type']} | "
            f"weight_decay={summary['weight_decay']} | "
